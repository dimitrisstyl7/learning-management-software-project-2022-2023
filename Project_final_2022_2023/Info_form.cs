...
namespace Project_final_2022_2023
{
    public partial class info_form : Form
    {
        ...
        private void info_form_Load(object sender, EventArgs e)
        {
            ...
            int info_panel_width = this.Width / 2 + this.Width / 4;
            int info_panel_height = this.Height / 2 + this.Width / 4;

            info_panel.Size = new Size(info_panel_width, info_panel_height);
            info_panel.Location = new Point(this.Width / 2 - info_panel_width / 2, this.Height / 2 - info_panel_height / 2);
